 ...
 <div class="container-fluid" style="padding: 0">
   <div class="col-md-12" style="padding: 0">  
         ...
         <div class="col-md-3" style="height: auto">
              <div class="container">
               <center><h2> <strong>Irrigation</strong> </h2>
              <img src="service pics\irrigation.jpg" style="width: 100%">
              </center></div>
         </div>
         ...
         <div class="col-md-9">
             <div id="saaridikkat" style="min-height: 500px">
                    <div class="container">
  <div class="panel-group" id="irrigation">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#irrigation" href="#irrigation1">K.Aggarwal</a>
        </h4>
      </div>
      <div id="irrigation1" class="panel-collapse collapse in">
        <div class="panel-body">
          <div class="col-md-12">
                  <div class="col-md-4">
                     <p>2 men available.<br>
                     No need to pay for lunch.
                     Work for 8 hours each day.<br>
                     Hours and price non-negotiable.</p>
                  </div>
                  <div class="col-md-2">
                                                  <div class="form-group" style="margin: 0">
                                                        <center><label for="selirrigation1">No. of days</label></center>
                                                        <select class="form-control" id="selirrigation1">
                                                          <option>1 </option>
                                                          <option>2 </option>
                                                          <option>3 </option>
                                                          <option>4 </option>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#irrigation" href="#irrigation2">Sarju Topi vala</a>
        </h4>
      </div>
      <div id="irrigation2" class="panel-collapse collapse ">
        <div class="panel-body">
          <div class="col-md-12">
                  <div class="col-md-4">
                         <p>4 men available.<br>
                     No need to pay for lunch.
                     Work for 8 hours each day.<br>
                     Hours and price non-negotiable.</p> 
                  </div>
                  <div class="col-md-2">
                                                  <div class="form-group" style="margin: 0">
                                                        <center><label for="selirrigation2">No. of days</label></center>
                                                        <select class="form-control" id="selirrigation2">
                                                          <option>1 </option>
                                                          <option>2 </option>
                                                          <option>3 </option>
                                                          <option>4 </option>
   ...
   <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#irrigation" href="#irrigation3">Rajkumar Mehta</a>
        </h4>
      </div>
      <div id="irrigation3" class="panel-collapse collapse ">
        <div class="panel-body">
          <div class="col-md-12">
                  <div class="col-md-4">
                    <p>3 men available.<br>
                     No need to pay for lunch.
                     Work for 6 hours each day.<br>
                     Hours and price non-negotiable.</p> 
                  </div>
                  <div class="col-md-2">
                                                  <div class="form-group" style="margin: 0">
                                                        <center><label for="selirrigation3">No. of days</label></center>
                                                        <select class="form-control" id="selirrigation3">
                                                          <option>1 </option>
                                                          <option>2 </option>
                                                          <option>3 </option>
                                                          <option>4 </option>
