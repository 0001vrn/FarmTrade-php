...
<center> 
 <div class="row" style="padding-top: 50px;">
   ...
   <div class="col-md-6"> 
           <a href="seeds.php"><img src="product pics\seed3.jpg" class="img-thumbnail" width="35%"></a>       
             <h4>Seeds</h4>
    </div>      
     <div class="col-md-6">       
       <a href="fertiliserfinal.php"><img src="product pics\fertiliser1.jpg" class="img-thumbnail" width=33%></a>
        <h4>Fertilisers</h4>     
      </div>   
      </div>
      ...
      <div class="row">
      <div class="col-md-6">
       <a href="toolfinal.php"> <img src="product pics\tool2.jpg" class="img-thumbnail" width=33%></a>
        <h4>Tools</h4>
      </div>
      <div class="col-md-6">
       <a href="produce.php"> <img src="product pics\produce1.jpg" class="img-thumbnail" width=37%></a>
        <h4>Produce</h4>
      </div>
      </div>
