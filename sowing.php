 ...
 <div class="container-fluid" style="padding: 0">
   <div class="col-md-12" style="padding: 0">  
         ...
         <div class="col-md-3" style="height: auto">
              <div class="container">
               <center><h2> <strong>Sowing</strong> </h2>
              <img src="service pics\sowing.jpg" style="width: 100%">
              </center></div>
         </div>
         ...
         <div class="col-md-9">
             <div id="saaridikkat" style="min-height: 500px">
                    <div class="container">
  <div class="panel-group" id="sowing">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#sowing" href="#sowing1">K.Aggarwal</a>
        </h4>
      </div>
      <div id="sowing1" class="panel-collapse collapse in">
          ...
          <div class="col-md-12">
                  ...
                  <div class="col-md-2">
                                                  <div class="form-group" style="margin: 0">
                                                        <center><label for="selsowing1">No. of days</label></center>
                                                        <select class="form-control" id="selsowing1">
                                                          <option>1 </option>
                                                          <option>2 </option>
                                                          <option>3 </option>
                                                          <option>4 </option>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#sowing" href="#sowing2">Sarju Topi vala</a>
        </h4>
      </div>
      <div id="sowing2" class="panel-collapse collapse ">
        <div class="panel-body">
          <div class="col-md-12">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-2">
                                                  <div class="form-group" style="margin: 0">
                                                        <center><label for="selsowing2">No. of days</label></center>
                                                        <select class="form-control" id="selsowing2">
                                                          <option>1 </option>
                                                          <option>2 </option>
                                                          <option>3 </option>
                                                          <option>4 </option>
   ...
   <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#sowing" href="#sowing3">Rajkumar Mehta</a>
        </h4>
      </div>
      <div id="sowing3" class="panel-collapse collapse ">
        <div class="panel-body">
          <div class="col-md-12">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-2">
                                                  <div class="form-group" style="margin: 0">
                                                        <center><label for="selsowing3">No. of days</label></center>
                                                        <select class="form-control" id="selsowing3">
                                                          <option>1 </option>
                                                          <option>2 </option>
                                                          <option>3 </option>
                                                          <option>4 </option>
