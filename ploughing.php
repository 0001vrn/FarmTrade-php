 ...
 <div class="container-fluid" style="padding: 0">
   <div class="col-md-12" style="padding: 0">  
         ...
         <div class="col-md-3" style="height: auto">
              <div class="container">
               <center><h2> <strong>Ploughing</strong> </h2>
              <img src="service pics\ploughing.jpg" style="width: 100%">
              </center></div>
         </div>
         ...
         <div class="col-md-9">
             <div id="saaridikkat" style="min-height: 500px">
                    <div class="container">
  <div class="panel-group" id="ploughing">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#ploughing" href="#ploughing1">K.Aggarwal</a>
        </h4>
      </div>
      <div id="ploughing1" class="panel-collapse collapse in">
          ...
          <div class="col-md-12">
                  ...
                  <div class="col-md-2">
                                                  <div class="form-group" style="margin: 0">
                                                        <center><label for="selploughing1">No. of days</label></center>
                                                        <select class="form-control" id="selploughing1">
                                                          <option>1 </option>
                                                          <option>2 </option>
                                                          <option>3 </option>
                                                          <option>4 </option>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#ploughing" href="#ploughing2">Sarju Topi vala</a>
        </h4>
      </div>
      <div id="ploughing2" class="panel-collapse collapse ">
        <div class="panel-body">
          <div class="col-md-12">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-2">
                                                  <div class="form-group" style="margin: 0">
                                                        <center><label for="selploughing2">No. of days</label></center>
                                                        <select class="form-control" id="selploughing2">
                                                          <option>1 </option>
                                                          <option>2 </option>
                                                          <option>3 </option>
                                                          <option>4 </option>
   ...
   <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#ploughing" href="#ploughing3">Rajkumar Mehta</a>
        </h4>
      </div>
      <div id="ploughing3" class="panel-collapse collapse ">
        <div class="panel-body">
          <div class="col-md-12">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-2">
                                                  <div class="form-group" style="margin: 0">
                                                        <center><label for="selploughing3">No. of days</label></center>
                                                        <select class="form-control" id="selploughing3">
                                                          <option>1 </option>
                                                          <option>2 </option>
                                                          <option>3 </option>
                                                          <option>4 </option>
